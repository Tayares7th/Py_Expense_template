...
- [X] When adding a new expense, Spender should be chosen among existing users (plus ou moins (^=^))
...
- [ ] Bonus : Improve your app in any way you want : More features, fancy report, any good idea will be rewarded
    - [X] Awesome feature 1 : L'utilisateur peut quitter le prompt avec l'option 'Exit'